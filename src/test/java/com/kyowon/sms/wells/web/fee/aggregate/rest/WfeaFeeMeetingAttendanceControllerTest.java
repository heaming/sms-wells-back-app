...
class WfeaFeeMeetingAttendanceControllerTest extends SpringTestSupport {
    ...
    void saveWellsFeeMeetingAttendances() throws Exception {
        // given
        SaveReq dto1 = new SaveReq("W01", "202301", "W0104", "02");
        ...
        // given
        SaveReq dto2 = new SaveReq("W01", "202301", "W0105", "02");
    ...
    void saveWellsFeeMeetingAttendancesForManager() throws Exception {
        // given
        SaveReq dto1 = new SaveReq("W02", "202301", "W0204", "02");
        ...
        // given
        SaveReq dto2 = new SaveReq("W02", "202301", "W0205", "02");
    ...
    void saveWellsFeeMeetingAttendancesForHomemaster() throws Exception {
        // given
        SaveReq dto1 = new SaveReq("W03", "202301", "W0302", "02");
        ...
        // given
        SaveReq dto2 = new SaveReq("W03", "202301", "W0301", "02");
