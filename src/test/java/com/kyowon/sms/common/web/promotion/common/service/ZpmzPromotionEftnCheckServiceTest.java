...
import com.kyowon.sms.common.web.promotion.common.mapper.ZpmzPromotionEftnCheckMapper;
...
class ZpmzPromotionEftnCheckServiceTest extends SpringTestSupport {
    ...
    private final ZpmzPromotionEftnCheckService service;
    private final ZpmzPromotionEftnCheckMapper mapper;

    List<HashMap<String, Object>> testDataList;
    ...
    void setData() {
         ...
         */
        testDataList = mapper.selectPromotionForJunitTest();
    }

    @Test
    @DisplayName("상품별 프로모션 정보 조회 - 데이터 존재")
    void getPromotionListByPdInfo() {
        ...
        // when
        List<ZpmzPromotionInfoDvo> result = service.getPromotionListByPdInfo(inputDvo);
    ...
    void getPromotionListByPdInfoNoData() {
        // given
    ...
    void getPromotionConditionListByPmotCd() {
        ...
        // when
        List<ZpmzPromotionInfoDvo> result = service.getPromotionListByPmotCd(pmotCd[0]);
    ...
    void getPromotionConditionListByPmotCdNodata() {
        // given
        String pmotCd = NO_DATA;

        // when
        List<ZpmzPromotionInfoDvo> result = service.getPromotionListByPmotCd(pmotCd);
    ...
    void getPromotionListByEftnChecksNormal() throws NoSuchFieldException, IllegalAccessException {
        ...
        // when
        List<ZpmzPromotionInfoDvo> result = service.getPromotionListByConditions(paramDvo);
    ...
    void getPromotionListByEftnChecksPriceError() throws NoSuchFieldException, IllegalAccessException {
    ...
    void getPromotionListByEftnChecksDateError() throws NoSuchFieldException, IllegalAccessException {
    ...
    private String[] getTestData(String filterKey) {
        ...
        if (testDataList.isEmpty()) {
            ...
            if (StringUtils.equals(filterKey, FILTER_KEY_PROMOTION)) {
                result[0] = Objects.toString(testDataList.get(0).get(FILTER_KEY_PROMOTION), "");
            } else {
                HashMap<String, Object> param = testDataList.stream().filter(item -> {
    ...
    private ZpmzPromotionInputCndtDvo getTestData(String[] filterKey) throws NoSuchFieldException, IllegalAccessException {
        ...
        if (testDataList.isEmpty()) {
            ...
            List<HashMap<String, Object>> paramList = testDataList.stream().filter(item -> {
            ...
            if (paramList != null && paramList.isEmpty()) {
                ...
                HashMap<String, Object> param = paramList.get(0);
