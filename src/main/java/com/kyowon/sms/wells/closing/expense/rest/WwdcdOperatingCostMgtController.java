...
import com.kyowon.sms.wells.closing.expense.service.WOpcsRgstMngtService;
...
public class WOpcsRgstMngtController {

    private final WOpcsRgstMngtService service;
    ...
    @GetMapping()
    public WOpcsRgstMngtDvo getWellsOrtCsRgstMngts(@Valid
                                                   SearchReq dto) {
        //운영비 금액현황
        //운영비 적요 현황
        WOpcsRgstMngtDvo dvo = service.getWellsOrtCsRgstMngts(dto);
