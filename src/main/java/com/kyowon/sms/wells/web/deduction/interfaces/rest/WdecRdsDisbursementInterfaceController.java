...
import com.kyowon.sms.wells.web.deduction.interfaces.service.WdecRdsProductDisbursementService;
...
public class WdecRdsDisbursementInterfaceController {
    ...
    private final WdecRdsProductDisbursementService service;
    ...
    public EaiWrapper createRdsDisbursement(
        @Valid
        @RequestBody
        EaiWrapper<WdecRdsProductDisbursementDto.SaveReq> reqWrapper
    ) {

        //Response용 EaiWrapper 생성
        EaiWrapper<WdecRdsProductDisbursementDto.SaveRes> resWrapper = reqWrapper.newResInstance();
        ...
        resWrapper.setBody(
            WdecRdsProductDisbursementDto.SaveRes.builder()
