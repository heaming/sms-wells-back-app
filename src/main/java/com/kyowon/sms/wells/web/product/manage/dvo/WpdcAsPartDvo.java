...
public class WpdcAsPartDvo {
    private String cols; /* 상품 수정시, 수정 요청된 컬럼 목록( ...,컬럼1,컬럼2,... )*/
    private String fstRgstUsrNm;
    private String fnlMdfcUsrNm;
    private String fstRgstDtm;
    private String fnlMdfcDtm;
    private String fnlMdfcUsrNmSet;
    private String fnlMdfcDeptNm;
    ...
    private BigDecimal pdctUprc; /* 제품단가 */
    private String pdctUprcUseYn; /* 제품단가사용여부 */
    private String slRcogPrdCd; /* 매출인식주기코드 */
    private String slRcogPitmDvCd; /* 매출인식시점구분코드 */
    private String slprcEstmBaseDvCd; /* 매출액산정기준구분코드 */
