...
public interface WdccSalesPerformMapper {
    ...
    PagingResult<WdccSalesPerformDvo> selectRentalSalesPages(SearchReq dto);

    PagingResult<WdccSalesPerformDvo> selectMembershipSalesPages(SearchReq dto);

    PagingResult<WdccSalesPerformDvo> selectRegularShippingSalesPages(SearchReq dto);
