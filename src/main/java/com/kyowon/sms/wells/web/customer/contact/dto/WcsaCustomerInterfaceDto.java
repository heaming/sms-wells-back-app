...
public class WcsaCustomerInterfaceDto {
     ...
     * 네이버렌탈 고객등록 req
     */
    @ApiModel(value = "WcsaCustomerInterfaceDto-CreateCustomerForNaverRentalReq")
    public record CreateCustomerForNaverRentalReq(
        @JsonProperty("CO_CD")
        String coCd, /*회사코드*/
        @JsonProperty("BIZ_DV_CD")
        String bizDvCd, /*업무구분코드*/
        @JsonProperty("PD_DV_CD")
        String pdDvCd, /*상품군구분코드*/
        @JsonProperty("COPN_DV_CD")
        String copnDvCd, /*법인격구분코드*/
        @JsonProperty("BRYY_MMDD")
        ...
        @JsonProperty("BAS_ADR")
        String basAdr, /*기본주소*/
        @JsonProperty("DTL_ADR1")
        String dtlAdr1, /*상세주소1*/
        @JsonProperty("DTL_ADR2")
        String dtlAdr2, /*상세주소2*/
        @JsonProperty("AK_PRG")
        String akPrg, /*요청프로그램*/
        @JsonProperty("RQR_EMPNO")
        String rqrEmpno, /*요청자사번*/
        @JsonProperty("IN_EQU")
        String inEqu, /*입력장비*/
        @JsonProperty("SFK_VAL")
        String sfkVal, /*회원세이프키*/
        @JsonProperty("CIK_VAL")
        String cikVal, /*CI키값*/
        @JsonProperty("HS_CTF_DT")
        String hsCtfDt /*본인인증일*/
    ) {}

    /**
     * 네이버렌탈 고객등록 res
     */
    @ApiModel(value = "WcsaCustomerInterfaceDto-CreateCustomerForNaverRentalRes")
    public record CreateCustomerForNaverRentalRes(
        @JsonProperty("CST_NO")
        String cstNo, /* 고객번호 */
        @JsonProperty("SFK_VAL")
        String sfkVal, /*세이프키*/
        @JsonProperty("SFK_VAL_IS_DTM")
        String sfkValIsDtm, /*세이프키발급일시*/
        @JsonProperty("RS_CD")
        String rsCd, /*결과코드*/
        @JsonProperty("RS_MSG")
        String rsMsg /*결과메시지*/
