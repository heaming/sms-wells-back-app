...
public class WcteRcpIstController {
    ...
    @ApiOperation(value = "접수 및 설치 현황 조회 페이징 조회", notes = "")
    @ApiImplicitParams(value = {
        ...
        @ApiImplicitParam(name = "pdDv", value = "제품구분", paramType = "query", required = true),
    ...
    @ApiOperation(value = "접수 및 설치 현황 조회 엑셀 다운로드", notes = "")
    @ApiImplicitParams(value = {
