...
/**
 * <pre>
 * W-SV-U-0011M01 소모품 배부현황(신입) Controller
 * </pre>
 *
 * @author SaeRomI.Kim
 * @since 2023-12-05
...
public class WsnaNewManagerBsConsumableController {
    ...
    @GetMapping
    @ApiOperation(value = "신입 소모품 배부현황 조회", notes = "신입 소모품 배부현황을 조회한다.")
    public List<HashMap<String, Object>> getNewManagerBsConsumable(@Valid
    SearchReq dto) {
        return service.getNewManagerBsConsumable(dto);
    }

    @PostMapping
    @ApiOperation(value = "신입 소모품 배부현황 저장", notes = "신입 소모품 배부내역을 저장한다.")
    ...
    @PostMapping("/request")
    @ApiOperation(value = "신입 소모품 배부현황 출고요청", notes = "신입 소모품 배부내역을 출고요청한다.")
