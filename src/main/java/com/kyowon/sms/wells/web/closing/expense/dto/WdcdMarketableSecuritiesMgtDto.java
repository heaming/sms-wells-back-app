...
public class WdcdMarketableSecuritiesMgtDto {

    // *********************************************************
    // Request Dto
    // *********************************************************
    // 운영비 원천세 정산(유가증권 제외) / 대상자 조회결과
    @ApiModel(value = "WdcdMarketableSecuritiesMgtDto-AdjustObjectReq")
    ...
    // *********************************************************
    // 운영비 원천세 정산(유가증권 제외) / 대상자 조회결과
    @ApiModel(value = "WdcdMarketableSecuritiesMgtDto-AdjustObjectRes")
    ...
    @ApiModel(value = "WdcdMarketableSecuritiesMgtDto-WithholdingTaxAdjustReq")
    ...
    // *********************************************************
    // 운영비 원천세 정산(유가증권 제외) /최종 원천세 정산 대상자
    @ApiModel(value = "WdcdMarketableSecuritiesMgtDto-WithholdingTaxAdjustRes")
    ...
    @ApiModel(value = "WdcdMarketableSecuritiesMgtDto-editReq")
