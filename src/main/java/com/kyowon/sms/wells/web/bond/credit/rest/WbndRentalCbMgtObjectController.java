...
public class WbndRentalCbMgtObjectController {
    ...
    @ApiImplicitParams(value = {
        @ApiImplicitParam(name = "cstNo", value = "고객번호", paramType = "path", required = true),
        @ApiImplicitParam(name = "baseYm", value = "기준년월", paramType = "query", required = true),
    })
    ...
    public PagingResult<SearchPaymentRes> getRentalCbMgtPaymentInfos(
        ...
        return service.getRentalCbMgtPaymentInfos(cstNo, baseYm, pageInfo);
    }
    ...
    public List<SearchPaymentRes> getRentalCbMgtPaymentInfoForExcelDownload(
        ...
        return service.getRentalCbMgtPaymentInfoForExcelDownload(cstNo, baseYm);
    }
}
