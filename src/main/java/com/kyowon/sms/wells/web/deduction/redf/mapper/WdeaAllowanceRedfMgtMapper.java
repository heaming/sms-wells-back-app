...
public interface WdeaAllowanceRedfMgtMapper {
    ...
    // M조직 연체
    PagingResult<WdeaAllowanceRedfMgtDvo> selectRedfBizdDelinquentMgts(SearchRedfBizdReq dto, PageInfo pageInfo);
    ...
    // M조직 연체 엑셀 다운로드
    List<WdeaAllowanceRedfMgtDvo> selectRedfBizdDelinquentMgts(SearchRedfBizdReq dto);
}
