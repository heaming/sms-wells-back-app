...
import com.kyowon.sms.wells.web.service.visit.mapper.WsnbServiceWorkInterfaceMapper;
...
public class WsnbServiceWorkInterfaceService {
    ...
    static final String P_WRK_GB = ""; // TODO RequestBody 값 여부 확인 필요
    static final String P_WRK_TYPE_DTL = ""; // TODO RequestBody 값 여부 확인 필요
    ...
    @Transactional
    public CreateRes createServiceWorks(CreateReq createReq) {
