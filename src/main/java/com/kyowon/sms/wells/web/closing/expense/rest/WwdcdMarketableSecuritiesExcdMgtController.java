...
@RestController
@Slf4j
@RequestMapping("/api/v1/sms/wells/expense/operating-cost/marketable-securities-excd/Withholding-tax-adj")
public class WwdcdMarketableSecuritiesExcdMgtController {

    //private final WwdcdMarketableSecuritiesExcdMgtService service;
