 ...
 * @since 2023.10.23
 */
public class WsnaMdProductReturningGoodsMgtDto {

    @ApiModel(value = "WsnaMdProductReturningGoodsMgtDto-SearchReq")
    ...
    @ApiModel(value = "WsnaMdProductReturningGoodsMgtDto-SearchRes")
    ...
    @ApiModel(value = "WsnaMdProductReturningGoodsMgtDto-SaveReq")
    ...
    @ApiModel(value = "WsnaMdProductReturningGoodsMgtDto-FindLogisticsCentersRes")
    public record FindLogisticsCentersRes(
        String codeId,
        String codeName
    ) {}

    @ApiModel(value = "WsnaMdProductReturningGoodsMgtDto-FindItmOstrNoReq")
