...
import static com.kyowon.sms.wells.web.service.common.dto.WsnyErrorCodeMgtDto.FindProductRes;
import static com.kyowon.sms.wells.web.service.common.dto.WsnyErrorCodeMgtDto.SearchReq;
...
public interface WsnyErrorCodeMgtMapper {
     ...
     * @return 조회결과
     */
    List<WsnyErrorCodeMgtDvo> selectErrorCodePages(SearchReq searchReq, PageInfo pageInfo);
     ...
     * @return 조회결과
     */
    List<WsnyErrorCodeMgtDvo> selectErrorCodePages(SearchReq searchReq);
