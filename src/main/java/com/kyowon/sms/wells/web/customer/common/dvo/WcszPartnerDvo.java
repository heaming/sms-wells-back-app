...
public class WcszPartnerDvo {
    ...
    private String epNmNo; /* ep 명 +  ep 사번 */
    private String epMpNo1; /* ep휴대폰번호1 */
    private String epMpNo2; /* ep휴대폰번호2 */
    private String epMpNo3; /* ep휴대폰번호3 */
    private String epOfficeTelNo1; /* EP전화번호1 */
    private String epOfficeTelNo2; /* EP전화번호2 */
    private String epOfficeTelNo3; /* EP전화번호3 */
    ...
    private String dtrcNmNo; /* 지국장 명 + 지국장 사번 */
