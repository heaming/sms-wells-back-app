...
public class WsnbServiceProcessingDto {
    ...
    @ApiModel("WsnbServiceProcessingIzDto-SearchExcelRes")
...
//            contactMexnoEncr = StringUtils.isNotEmpty(contactMexnoEncr) ? DbEncUtil.dec(contactMexnoEncr) : "";
            if(StringUtils.isNotEmpty(mexnoEncr)){
                mexnoEncr = DbEncUtil.dec(mexnoEncr);
                cralTno = cralLocaraTno + "-" + mexnoEncr + "-" + cralIdvTno;
            }

            if(StringUtils.isNotEmpty(contactMexnoEncr)){
                contactMexnoEncr = DbEncUtil.dec(contactMexnoEncr);
                contactCralTno = contactCralLocaraTno + "-" + contactMexnoEncr + "-" + contactCralIdvTno;
            }
        }
    }
}
