...
public class WwpseGenenalAffairsElcBizAkDto {
    // *********************************************************
    // Request Dto
    // *********************************************************
    // 총무전자업무요청 Search Request Dto
    @Builder
    @ApiModel("WwpseGenenalAffairsElcBizAkDto-BaseSearchReq")
    ...
    @ApiModel("WwpseGenenalAffairsElcBizAkDto-SearchReq")
    ...
    @ApiModel("WwpseGenenalAffairsElcBizAkDto-PopupSearchRes")
    ...
    @ApiModel("WwpseGenenalAffairsElcBizAkDto-OgbsBldBasRes")
    ...
    @ApiModel("WwpseGenenalAffairsElcBizAkDto-BaseSearchRes")
    ...
    @ApiModel("WwpseGenenalAffairsElcBizAkDto-SearchRes")
    ...
    @ApiModel("WwpseGenenalAffairsElcBizAkDto-SaveReq")
