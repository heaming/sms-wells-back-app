...
import com.kyowon.sms.wells.web.contract.ordermgmt.service.WwctaDocumentRcpPssService;
...
public class WwctaDocumentRcpPssController {

    private final WwctaDocumentRcpPssService service;
    ...
    public List<SearchRes> getDocumentRcpPss(
        @Valid
        SearchReq dto
    ) {
        return service.getDocumentRcpPss(dto);
    }
}
