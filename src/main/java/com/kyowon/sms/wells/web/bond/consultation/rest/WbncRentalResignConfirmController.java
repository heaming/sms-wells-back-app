...
public class WbncRentalResignConfirmController {
    ...
    @ApiImplicitParams(value = {
        @ApiImplicitParam(name = "authRsgCnfmdtStart", value = "확정년월시작", paramType = "query", required = true),
        @ApiImplicitParam(name = "authRsgCnfmdtEnd", value = "확정년월종료", paramType = "query", required = true),
