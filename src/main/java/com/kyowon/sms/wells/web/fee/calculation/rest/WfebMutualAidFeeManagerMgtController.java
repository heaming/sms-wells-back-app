...
import com.kyowon.sms.wells.web.fee.calculation.service.WfebMutualAidFeeManagerMgtService;
...
@RestController
@RequestMapping(CtFeeConst.REST_URL_V1 + "/mutual-aid-manager")
@Slf4j
public class WfebMutualAidFeeManagerMgtController {

     private final WfebMutualAidFeeManagerMgtService service;
